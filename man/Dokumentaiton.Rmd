...
2. Daten zusammenkopieren
3. Ausgezählte Gemeinden filtern/danach sortieren

## Schwankungsbreite

Die Schwankungsbreite wird mittels Bootstrapping berechnet. Das funktioniert hier leider noch nicht. Da muss ich noch nachschauen wie wir das früher genau gemacht haben.
Außerdem beinhaltet die Schwankungsbreite nur jene der Urnenstimmen. Wie schätzt man die Schwankungsbreite der Briefwahlstimmen? Gute Frage, wir haben einfach immer +xy gesagt.
